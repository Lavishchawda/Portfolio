...
function Contact() {
  return (
    <div id='contact' className="bg-slate-900 px-4 md:px-12 lg:px-24 xl:px-48 pt-12">
      <h3 className="text-white text-center mb-6 text-lg md:text-xl lg:text-2xl">Contact Me</h3>
