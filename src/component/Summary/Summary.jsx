...
function Summary() {
  ...
  return (
    <div className="relative w-full pt-20 px-64"> {/* Make the parent div relative */}
      ...
      <h3 className="text-white text-center mb-4 text-2xl font-poppins">Summary</h3>

      {/* Adding Framer Motion for smooth animations */}
      <motion.p 
        ref={ref}
        className="text-white-light text-center relative z-10 font-poppins" // Use the new font class
      ...
      <div className="w-full flex justify-center py-6">
        <a 
          ...
          className="light-text w-fit m-auto flex gap-2 items-center font-poppins" // Use the new font class
        >
